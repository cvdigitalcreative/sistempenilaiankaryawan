            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  { ?>
                    <tr>
                        <td style="vertical-align: middle;"><?php echo $data[$i][1];?></td>
                        <td style="vertical-align: middle;"><?php echo $data[$i][2];?></td>
                        <td style="vertical-align: middle;"><?php echo $data[$i][3];?></td>
                        <td> 
                            <!-- <img style="width: 100px;" src="<?php echo base_url().$row->upload_path.'/'.$row->laporan_path;?>"> -->
                            <div class="btn-group"> 
                              <?php echo form_open('AdminGM/perpanjang_kontrak_update'); ?>
                                <input type="hidden" name="id" value="<?php echo $data[$i][0];?>"/>
                                 <input type="hidden" name="status_perpanjang_kontrak" value="1"/>
                                <button type="submit" class="btn btn-info">Perpanjang</button> 
                             <?php echo form_close(); ?>
                              <?php echo form_open('AdminGM/perpanjang_kontrak_update'); ?>
                                <input type="hidden" name="id" value="<?php echo $data[$i][0];?>"/>
                                 <input type="hidden" name="status_perpanjang_kontrak" value="99"/>
                                <button type="submit" class="btn btn-info">Tidak Diperpanjang</button> 
                             <?php echo form_close(); ?>
