    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
            ...
            <i class=""></i> <a href="<?php echo base_url(); ?>AdminHOD" > <span>Home</span></a>
         ...
         <li>
            ...
            <i class=""></i><a href="<?php echo base_url(); ?>AdminHOD/formulirwawancara" > <span>Formulir Wawancara</span></a>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open('AdminHOD/formulirwawancara_toDatabase');?>
               <?php
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="posisi" name="posisi" placeholder="Posisi/Jabatan">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" name="akhir_kontrak">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
              ...
              <!-- /.box-body -->
              <input type="hidden" class="form-control" id="pemberi_nilai" name="pemberi_nilai" value="1">
